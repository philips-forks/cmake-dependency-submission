...
describe('extractFetchContentGitDetails', () => {
    ...
    test('Returns matches for single-line FetchContent_Declare', () => {
        expect((0, cmake_detector_1.extractFetchContentGitDetails)('FetchContent_Declare(GIT_REPOSITORY https://github.com/owner/repo GIT_TAG v1.0.0)')).toStrictEqual([expectedResult]);
    });
...
describe('parsePackageType', () => {
    test('Returns correct PURL type for GitHub URL', () => {
        expect((0, cmake_detector_1.parsePackageType)('https://github.com/foo/bar')).toBe('generic');
    });
